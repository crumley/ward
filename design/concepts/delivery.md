...
`../../intent/concepts/delivery.md` — the delivery, privacy-boundary, never-merge-to-main,
lifecycle-hook, and workflow-policy **constraints**; and `../../intent/foundation/principles.md`
...
- **Workflow policy** — encoded as a **workspace-owned skill** (vs. a config document — open); the
  ...
  reconciliation UX. _(The reconcile-not-clobber pattern is general — see `reflection.md` and the
  principle.)_
