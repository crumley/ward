...
`../../intent/concepts/reflection.md` — the goal-directed / map-reduce / cursor / async-proposal
**constraints**, and the version-stamp / update-vs-migrate / reconciliation rules.
