...
`../../intent/02-subsystems/01-harness.md` — run an agent, expose a resolvable handle, per-scope
...
- The **per-harness handle format** and history location (shared with
  `../01-concepts/00-sessions.md`).
