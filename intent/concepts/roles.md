...
link here: `sessions.md` references the axes and the wake-as-lifecycle-op; `subsystems/messaging.md`
realizes the flows; `subsystems/harness.md` realizes fork modes.
