...
> **Design:** `../../design/subsystems/multiplexer.md`. **Status:** placeholder skeleton.
...
- Support visual grouping/identification of sessions (see `theming.md`).
- Live process state is a **cache over the record**, never the source of truth (`principles.md`
  §16).
...
- **Messaging vs. multiplexer overlap** — how much of dispatch/wake rides on the multiplexer vs. the
  store (shared with `messaging.md`).
