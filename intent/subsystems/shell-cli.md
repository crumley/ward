...
> **Design:** `../../design/subsystems/shell-cli.md`. **Status:** placeholder skeleton.
...
- The structured interface is organized around **nouns and verbs**; the interactive layer adds
  **mnemonic shorthands** for common operations and **records command usage** for later
  optimization.
- The **human is the default caller** (`principles.md` §8); an agent caller identifies itself (and
  its scope, persona, working directory) — the human never declares they are the human.
