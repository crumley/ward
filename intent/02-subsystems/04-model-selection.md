...
> **Design:** `../../design/02-subsystems/04-model-selection.md`. **Status:** placeholder skeleton.
...
- Honor the role logic (`01-concepts/02-roles.md`): **fast/shallow** where the job is bookkeeping
  (house supervisor, charge nurse), **deep/high-thinking** where the job is hard work (rooms).
- **Model-agnostic** (`01-principles.md` §5): no concept assumes a particular model; model ids are
