...
> **Design:** `../../design/02-subsystems/03-messaging.md`. **Status:** placeholder skeleton.

## Responsibility

Realize the **dispatch / report / wake** flows (defined as concepts in `01-concepts/02-roles.md`) —
...
defined in `01-concepts/02-roles.md`; this owns their delivery guarantees.

## Open questions

- **Messaging vs. multiplexer overlap** — the split between live delivery and the record (shared
  with `02-multiplexer.md`).
